...
\usepackage{xunicode}
\usepackage{xltxtra}
\defaultfontfeatures{Numbers=OldStyle, Ligatures={Common}, Mapping=tex-text}
\setromanfont[ItalicFont={* Slanted}, BoldFont={* Demi}, SmallCapsFont={* Caps}] {Latin Modern Roman}
